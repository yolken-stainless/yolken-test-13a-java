...
package com.configure_me_yolken_test_13a.api.models.pets

import com.configure_me_yolken_test_13a.api.core.Enum
import com.configure_me_yolken_test_13a.api.core.ExcludeMissing
...
import com.configure_me_yolken_test_13a.api.core.checkKnown
import com.configure_me_yolken_test_13a.api.core.checkRequired
import com.configure_me_yolken_test_13a.api.core.toImmutable
...
private constructor(
    ...
    /**
     * @throws YolkenTest13aInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws YolkenTest13aInvalidDataException if the JSON field has an unexpected type (e.g. if
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: YolkenTest13aInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws YolkenTest13aInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw YolkenTest13aInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws YolkenTest13aInvalidDataException if this class instance's value does not have
         *   the expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                YolkenTest13aInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws YolkenTest13aInvalidDataException if the JSON field has an unexpected type (e.g.
