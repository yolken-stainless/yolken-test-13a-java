...
/**
 * A client for interacting with the Yolken Test 13a REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface YolkenTest13aClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): YolkenTest13aClientAsync
    ...
    /**
     * A view of [YolkenTest13aClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
