...
package com.configure_me_yolken_test_13a.api.services
...
import com.configure_me_yolken_test_13a.api.core.jsonMapper
import com.configure_me_yolken_test_13a.api.errors.BadRequestException
import com.configure_me_yolken_test_13a.api.errors.InternalServerException
import com.configure_me_yolken_test_13a.api.errors.NotFoundException
import com.configure_me_yolken_test_13a.api.errors.PermissionDeniedException
import com.configure_me_yolken_test_13a.api.errors.RateLimitException
import com.configure_me_yolken_test_13a.api.errors.UnauthorizedException
import com.configure_me_yolken_test_13a.api.errors.UnexpectedStatusCodeException
import com.configure_me_yolken_test_13a.api.errors.UnprocessableEntityException
import com.configure_me_yolken_test_13a.api.errors.YolkenTest13aException
...
internal class ErrorHandlingTest {
    ...
    private lateinit var client: YolkenTest13aClient

    @BeforeEach
    fun beforeEach(wmRuntimeInfo: WireMockRuntimeInfo) {
        client =
            YolkenTest13aOkHttpClient.builder()
    ...
    fun storeListInventoryInvalidJsonBody() {
        ...
        val e = assertThrows<YolkenTest13aException> { storeService.listInventory() }
