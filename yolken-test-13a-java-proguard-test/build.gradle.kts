...
dependencies {
    testImplementation(project(":yolken-test-13a-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../yolken-test-13a-java-core/src/main/resources/META-INF/proguard/yolken-test-13a-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_yolken_test_13a.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../yolken-test-13a-java-core/src/main/resources/META-INF/proguard/yolken-test-13a-java-core.pro",
