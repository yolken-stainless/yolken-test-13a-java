...
import com.configure_me_yolken_test_13a.api.core.http.HttpRequestBody
import com.configure_me_yolken_test_13a.api.core.http.HttpResponse
import com.configure_me_yolken_test_13a.api.errors.YolkenTest13aIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw YolkenTest13aIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(YolkenTest13aIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("YOLKEN_TEST_13A_LOG")?.lowercase()) {
