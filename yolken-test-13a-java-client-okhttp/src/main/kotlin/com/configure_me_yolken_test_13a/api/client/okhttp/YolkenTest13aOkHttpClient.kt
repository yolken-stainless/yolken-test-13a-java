...
import com.configure_me_yolken_test_13a.api.client.YolkenTest13aClientImpl
...
/**
 * A class that allows building an instance of [YolkenTest13aClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest13aOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest13aClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest13aClient = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest13aOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [YolkenTest13aClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest13aClient =
            YolkenTest13aClientImpl(
                clientOptions
                    .httpClient(
