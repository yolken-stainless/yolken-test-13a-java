...
package com.configure_me_yolken_test_13a.api.client.okhttp

import com.configure_me_yolken_test_13a.api.client.YolkenTest13aClientAsync
import com.configure_me_yolken_test_13a.api.client.YolkenTest13aClientAsyncImpl
import com.configure_me_yolken_test_13a.api.core.ClientOptions
import com.configure_me_yolken_test_13a.api.core.Sleeper
import com.configure_me_yolken_test_13a.api.core.Timeout
import com.configure_me_yolken_test_13a.api.core.http.Headers
import com.configure_me_yolken_test_13a.api.core.http.HttpClient
import com.configure_me_yolken_test_13a.api.core.http.QueryParams
...
/**
 * A class that allows building an instance of [YolkenTest13aClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest13aOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest13aClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest13aClientAsync = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest13aOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_yolken_test_13a.api.core.jsonMapper]. The default is
        ...
        /**
         * Returns an immutable instance of [YolkenTest13aClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest13aClientAsync =
            YolkenTest13aClientAsyncImpl(
                clientOptions
                    .httpClient(
